...
See also [7.3 Sensors, actuators, and end effectors](../../Chapter-07-Mechatronics-foundations/07-03-Sensors-actuators-end-effectors/index.md) for component specifications and [8.1 Working with device data and diagnostics](../08-01-Working-with-device-data-and-diagnostics/index.md) for monitoring power consumption.
